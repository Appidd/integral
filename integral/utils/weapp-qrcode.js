...
Object.defineProperty(exports, "__esModule", {
    value: !0
}), exports.default = void 0, function() {
    function e(t, e) {
        for (var r = 1, o = function(t) {
            var e = encodeURI(t).toString().replace(/\%[0-9a-fA-F]{2}/g, "a");
            return e.length + (e.length != t ? 3 : 0);
        }(t), n = 0, a = L.length; n <= a; n++) {
            var s = 0;
            switch (e) {
              case i.L:
                s = L[n][0];
        ...
        if (r > L.length) throw new Error("Too long data");
        return r;
    }
    function r(t) {
    ...
    r.prototype = {
        ...
        mapData: function(t, e) {
            for (var r = -1, o = this.moduleCount - 1, n = 7, i = 0, a = this.moduleCount - 1; a > 0; a -= 2) for (6 == a && a--; ;) {
                for (var s = 0; s < 2; s++) if (null == this.modules[o][a - s]) {
                    var h = !1;
                    i < t.length && (h = 1 == (t[i] >>> n & 1)), c.getMask(e, o, a - s) && (h = !h), 
        ...
        for (var n = _.getRSBlocks(t, e), i = new C(), a = 0; a < r.length; a++) {
            var s = r[a];
        ...
        for (var r = 0, o = 0, n = 0, i = new Array(e.length), a = new Array(e.length), s = 0; s < e.length; s++) {
            ...
            r += h;
            var g = c.getErrorCorrectPolynomial(u), f = new v(i[s], g.getLength() - 1).mod(g);
            a[s] = new Array(g.getLength() - 1);
            for (l = 0; l < a[s].length; l++) {
                var d = l + f.getLength() - a[s].length;
                a[s][l] = d >= 0 ? f.get(d) : 0;
            }
        }
        var p = 0;
        for (l = 0; l < e.length; l++) p += e[l].totalCount;
        var m = new Array(p), _ = 0;
        for (l = 0; l < o; l++) for (s = 0; s < e.length; s++) l < i[s].length && (m[_++] = i[s][l]);
        for (l = 0; l < n; l++) for (s = 0; s < e.length; s++) l < a[s].length && (m[_++] = a[s][l]);
        return m;
    };
    for (var n = {
        MODE_NUMBER: 1,
        ...
        Q: 3,
        H: 2
    }, a = 0, s = 1, h = 2, u = 3, l = 4, g = 5, f = 6, d = 7, c = {
    ...
    _.getRSBlocks = function(t, e) {
        ...
        for (var o = r.length / 3, n = [], i = 0; i < o; i++) for (var a = r[3 * i + 0], s = r[3 * i + 1], h = r[3 * i + 2], u = 0; u < a; u++) n.push(new _(s, h));
        return n;
